...
-If you'd like to print out all parameters to text files, call the output_parameters(csp_dispatch_opt *optinst, unordered_map<std::string, double> &pars, int nt) function found on line 3049.
